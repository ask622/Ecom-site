...
export default function HeroSection() {
  return (
    ...
    >
      <div className=" bg-opacity-50 p-6 sm:p-10 rounded-xl max-w-3xl w-full text-white mt-16 lg:mt-0 backdrop-blur-sm">
        ...
        {/* Search Bar */}
        <div className="flex flex-col gap-4 md:flex-row md:items-end bg-white p-4 rounded-2xl text-black w-full max-w-4xl">
          ...
          <div className="w-full md:w-auto">
            <button
              className="w-full md:w-28 h-10 bg-[#ba7894] hover:bg-[#b21858] text-white rounded-full text-sm flex items-center justify-center gap-2 transition"
            >
              Search
