  ...
  return (
    <div className="bg-[#FBF2E0] w-full py-20">
      <div className="max-w-lg mx-auto text-center">
        <h3 className="text-md text-[#BA7894] tracking-wider mb-2">SCHEDULE YOUR PRESENCE</h3>
        <h1 className="text-xl font-bold mb-2 text-[#2c2c2c]">Get in touch</h1>
        <p className="text-sm text-gray-500 mb-10">
          There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.
        </p>
        <div className="bg-white p-8 ml-15 rounded-2xl w-110  h-100 shadow-lg">
