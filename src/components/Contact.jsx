  ...
  return (
    <div className="bg-[#FBF2E0] w-full py-20">
      <div className="max-w-xl mx-auto text-center">
        {/* Heading */}
        <h3 className="text-lg text-[#BA7894] tracking-wider mb-2">SCHEDULE YOUR PRESENCE</h3>
        <h1 className="text-3xl font-bold mb-2 text-[#2c2c2c]">Get in touch</h1>
          ...
          <form className="space-y-4">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Name"
                className="w-full border border-gray-500 rounded px-10 py-2 focus:outline-none"
              />
            </div>
            <div className="relative">
            ...
            <div className="relative">
              ...
              <textarea
                ...
                rows="3"
                className="w-full border border-gray-500 rounded px-10 py-2 focus:outline-none resize-none"
              ></textarea>
            </div>
