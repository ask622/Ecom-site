  ...
  return (
    <div className='flex flex-col w-full'>
      <div className='text-center'>
        <h2 className='text-md text-[#ba7894] mt-7'>OUR SERVICES</h2>
        <h1 className='text-xl font-bold pb-3'>Recommended</h1>
        ...
        <div className='flex '>
          {services.map((service, idx) => (
            <div key={idx} className='rounded-xl w-60 shadow flex flex-col items-start h-85 mx-5'>
              <img src={service.img} alt={service.title} className='w-60 h-30 rounded-t-xl mb-1 object-cover' />
